...
import { GreetingIcon, BookIcon, SearchIcon, StarIcon } from "./icons";
...
function TutorialIcon({ icon }) {
  switch(icon) {
    case "greet": return <GreetingIcon size={24} color="#3B82F6" />;
    case "book": return <BookIcon size={24} color="#F59E0B" />;
    case "search": return <SearchIcon size={24} color="#10B981" />;
    case "star": return <StarIcon size={24} color="#8B5CF6" />;
    default: return null;
  }
}
      ...
      <div style={{ padding: "0 28px" }}>
        <div style={{
          ...
          <h2 style={{
            ...
            color: "#111827", marginBottom: 10, display: "flex", alignItems: "center", gap: 10
          }}>
            <div style={{
              width: 32, height: 32, borderRadius: 10,
              background: `${tip.color}18`, display: "flex", alignItems: "center", justifyContent: "center"
            }}>
              <TutorialIcon icon={tip.icon} />
            </div>
            {tip.title}
          </h2>
